...
| Bucket | Keys | Note |
|---|---|---|
| `ijorethnicpartners` | `state/myntra_groupid.json` (styleGroupId ledger), `myntra/…` (uploaded product images + outputs) | Instance role needs **ListBucket** too — without it a missing key returns 403 not 404 and the app 500s. |
